...
- assumes safe, conservative text parsing path by default
- no reader fast-path options enabled by default
...
class RunConfig:
    ...
    assume_sorted_ids: bool = False
    use_fromstring_parser: bool = False
    chunk_size_atoms: int = 128
    freq_block_size: int = 256
...
if __name__ == "__main__":
    ...
    config = RunConfig(
        ...
        # Parse ATOMS blocks with classic split/float parser (v1 default).
        use_fromstring_parser=False,
